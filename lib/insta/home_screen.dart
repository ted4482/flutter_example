  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
          children: [
            Container(
              width: 80, height: 80, margin: const EdgeInsets.symmetric(vertical: 8, horizontal: 8),
...
final feedDataList = [
  FeedData(userName: 'User1', likeCount: 10, content: '테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, 테스트 데이터1, '),
  FeedData(userName: 'User2', likeCount: 20, content: '테스트 데이터2'),
  FeedData(userName: 'User3', likeCount: 30, content: '테스트 데이터3'),
  FeedData(userName: 'User4', likeCount: 40, content: '테스트 데이터4'),
  FeedData(userName: 'User5', likeCount: 50, content: '테스트 데이터5'),
  FeedData(userName: 'User6', likeCount: 60, content: '테스트 데이터6'),
  FeedData(userName: 'User7', likeCount: 70, content: '테스트 데이터7'),
  FeedData(userName: 'User8', likeCount: 80, content: '테스트 데이터8'),
  FeedData(userName: 'User9', likeCount: 90, content: '테스트 데이터9'),
];
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Container(width: double.infinity, height: 280, color: Colors.indigo.shade300,), // 사진 공간
        Padding(
